...
**Exercise to be handed in by 13th April, 2025 (extra credit will be awarded if you do this when taking the course after 2025)**
...
<span style="color:blue">2. Write down the assumptions of this model and an equation for the probability that you would see sparrows at a site.</span>

<span style="color:blue">3. What is the estimated coefficient for the effect of mean temperature (`temp.mean.sc`)? And what is the 95% confidence interval for this coefficient? Does this suggest an effect of temperature?</span>
