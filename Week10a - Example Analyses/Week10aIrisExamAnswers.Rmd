---
title: "Dataset 2: Iris petals - EXAM STYLE ANSWERS"
...
```{r ReadIris, warning = FALSE, error = FALSE, eval = TRUE, echo = TRUE}
...
```{r Model1, warning = FALSE, error = FALSE, eval = TRUE, echo = TRUE}
# Model 1
...
```{r Plot1, warning = FALSE, error = FALSE, eval = TRUE, echo = TRUE}
# Graph 1
...
```{r Model2, warning = FALSE, error = FALSE, eval = TRUE, echo = TRUE}
# Model 2
