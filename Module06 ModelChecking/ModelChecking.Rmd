...
```{r QQPlotSimData1check, echo=FALSE,fig.height=5}
par(mfrow=c(1,2))
plot(SimData$x, SimData$y1, main="Data Set 1")
...
```{r QQPlotSimData2Acheck, echo=FALSE,fig.height=5}
par(mfrow=c(1,2))
plot(SimData$x, SimData$y2, main="Data Set 2")
  qqnorm(resid(Models$mod2));   qqline(resid(Models$mod2))
```

## Exercise: Data set 2

```{r QQPlotSimData2check, echo=FALSE,fig.height=5}
par(mfrow=c(1,2))
plot(SimData$x, SimData$y2, main="Data Set 2")
  qqnorm(resid(Models$mod2));   qqline(resid(Models$mod2))
```

The residuals look OK (and you might be able to guess how I created data serts 1 & 2)


## Exercise: Data set 3

```{r QQPlotSimData3Acheck, echo=FALSE,fig.height=5}
par(mfrow=c(1,2))
plot(SimData$x, SimData$y3, main="Data Set 3")
...
```{r QQPlotSimData4check, echo=FALSE,fig.height=5}
par(mfrow=c(1,2))
plot(SimData$x, SimData$y4, main="Data Set 4")
  qqnorm(resid(Models$mod4));   qqline(resid(Models$mod4))
```

## Exercise: Data set 4

```{r QQPlotSimData4Acheck, echo=FALSE,fig.height=5}
par(mfrow=c(1,2))
plot(SimData$x, SimData$y4, main="Data Set 4")
  qqnorm(resid(Models$mod4));   qqline(resid(Models$mod4))
```
...
```{r QQPlotSimData5check, echo=FALSE,fig.height=5}
par(mfrow=c(1,2))
plot(SimData$x, SimData$y5, main="Data Set 5")
...
```{r QQPlotSimData6check, echo=FALSE,fig.height=5}
par(mfrow=c(1,2))
plot(SimData$x, SimData$y6, main="Data Set 6")
...
```{r QQPlotSimData7check, echo=FALSE,fig.height=5}
par(mfrow=c(1,2))
plot(SimData$x7, SimData$y7, main="Data Set 7")
  qqnorm(resid(Models$mod7));   qqline(resid(Models$mod7))
```

## Exercise: Data set 7

```{r QQPlotSimData7Acheck, echo=FALSE,fig.height=5}
par(mfrow=c(1,2))
plot(SimData$x, SimData$y7, main="Data Set 7")
  qqnorm(resid(Models$mod7));   qqline(resid(Models$mod7))
```
...
```{r QQPlotSimData8check, echo=FALSE,fig.height=5}
par(mfrow=c(1,2))
plot(SimData$x, SimData$y8, main="Data Set 8")
  qqnorm(resid(Models$mod8));   qqline(resid(Models$mod8))
```

## Exercise: Data set 8

```{r QQPlotSimData8Acheck, echo=FALSE,fig.height=5}
par(mfrow=c(1,2))
plot(SimData$x, SimData$y8, main="Data Set 8")
  qqnorm(resid(Models$mod8));   qqline(resid(Models$mod8))
```
...
```{r PlotAllCooksD, echo=FALSE, eval=FALSE}
par(mfrow=c(4,2), mar=c(2,2,1,1))
lapply(Models, function(mod) {
