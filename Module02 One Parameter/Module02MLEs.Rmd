...
to get many samples, so we have created a function to do this (we did create an app hat you could use, but teh server it ran on was shut down. Sorry).
...
``` 
 ...
 This function was created in R, it simulates the idea of collecting data in the 
 way described above. 
 Simulations can be very useful when it is hard to collect data ourselves.
 
You can also source the code into your own R session and run the function there.
...
```{r SourceFunctions, warning = FALSE, error = FALSE, eval = TRUE, echo = TRUE}
# You can find the script with the functions for this week at this url:
# https://oharar.github.io/ST2304/Module02%20One%20Parameter/Module02Functions.R

# Source the script directly from the internet
source('https://oharar.github.io/ST2304/Module02%20One%20Parameter/Module02Functions.R')
 ...
 **This idea of variation is really important** we can try and visualise it 
 ...
 observed data sets for $p$ = 0.4 AND $p$ = 0.6. Two bar charts
 will be plotted. How does the distribution of the number of times you see 
 Land change when the probability of seeing land changes? For example, 
 if you think about seeing Land 4 times, how often do you get it with $p=0.4$, 
 and with $p=0.6$? What does this mean for trying to estimate $p$?</span>
...
# we put the simGlobe function inside table(). This counts how many times we 
# see land 0, 1, 2, ... times.
# simGlobe creates our x argument for table()
#["Land",] tells R to take only the row with number of Land
# plot() then works on the table, because R recognises it as a table and knows 
#  how to handle it. We use lwd=8 and lend=3 toi make it look nicer, 
#  and axis() to label all of the numbers.
# main changes the title
# xlab changes the x label

plot(table(simGlobe(0.4, 12, 100)["Land",]), xlim=c(0,12), xlab = "Number of land", 
     ylab="Frequency", main = "0.4", lwd=8, lend=3)
axis(1, at=0:12)
plot(table(simGlobe(0.6, 12, 100)["Land",]), xlim=c(0,12), xlab = "Number of land", 
     ylab="Frequency", main = "0.6", lwd=8, lend=3)
axis(1, at=0:12)
...
```{r dbinom, warning = FALSE, error = FALSE, eval = TRUE, echo = TRUE}
# Code to use dbinom()
...
# Part F - R - Inside the functions
 ...
 [script](https://oharar.github.io/ST2304/Module02%20One%20Parameter/Module02Functions.R).
...
<div style="position: relative; width: 100%; height: 0; padding-bottom: 56.25%">
	<iframe src="https://ntnu.cloud.panopto.eu/Panopto/Pages/Embed.aspx?id=9c221c95-4e41-41b2-8de2-ae2200a0159c&autoplay=false&offerviewer=true&showtitle=true&showbrand=true&captions=true&interactivity=all" style="border: 1px solid #464646; position: absolute; top: 0; left: 0; width: 100%; height: 100%; box-sizing: border-box;" allowfullscreen allow="autoplay" aria-label="Panopto Embedded Video Player" aria-description="ST2304w2Summary"></iframe>
</div>
--->
