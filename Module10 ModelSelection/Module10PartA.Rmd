...
The material is split into 3 modules (because one was getting too long). This is the first, [the second is about hypothesis testing](Module10PartB.html),  and [the third is about exploratory model selection](Module10PartC.html). You should try to follow them in order.
...
Next, you should go onto the next module, about [about hypothesis testing](Module10PartB.html). The final module will be last, and is [about exploratory model selection](Module10PartC.html).
