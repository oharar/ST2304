...
You should work through the exercise in groups and write answers in a separate document to be submitted on Blackboard by **Sunday 1st February midnight 2026 (or another date if it is not 2026)** (you may see this as Monday 2nd, if I allow an extra few minutes for panic). 
