...
```{r warning = FALSE, error = FALSE, include = TRUE, echo = TRUE}
...
You should work through the exercise in groups and write answers in a separate document to be submitted on Blackboard by **Sunday 1st February midnight 2026 (or another date if it is not 2025)** (you may see this as Monday 2nd, if I allow an extra few minutes for panic). 
...
```{r OptimalHelp, warning = FALSE, error = FALSE, include = TRUE, echo = TRUE, eval=FALSE}
?optimise
```
...
```{r ReadData, warning = FALSE, error = FALSE, include = FALSE, echo = FALSE, eval = FALSE}
...
```{r PlotStuff, warning = FALSE, error = FALSE, include = FALSE, echo = FALSE, eval = FALSE}
...
```{r Binom, warning = FALSE, error = FALSE, include = FALSE, echo = FALSE, eval = FALSE}
...
# Help! what probabilities (probability of being female) do I use?
# You can use any but choosing a large number of possibilities covering 
...
```{r MLE, warning = FALSE, error = FALSE, include = TRUE, eval = FALSE}
...
```{r Bonimal, warning = FALSE, error = FALSE, include = TRUE, eval = FALSE}
...
plot(x=Probabilities, y=likelihoods, type="l", ylab="Likelihood", xlab="Number of dragons")
...
```{r ObsAb, warning = FALSE, error = FALSE, include = TRUE, echo = TRUE, eval = FALSE}
...
```{r PoissonDist, warning = FALSE, error = FALSE, include = TRUE, eval = FALSE}
...
```{r EstPoiss, warning = FALSE, error = FALSE, include = TRUE, eval = FALSE}
# replot the outcome
plot(lambdas, likelihoods.Pois, type="l", ylab="Likelihood", xlab="Lambda (mean)")
...
($\lambda$) of adult dragons in Trondheim.
...
```{r ApproxPoiss, warning = FALSE, error = FALSE, include = TRUE, echo = TRUE, eval = FALSE}
