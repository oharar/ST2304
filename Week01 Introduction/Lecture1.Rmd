...
- Blackboard
- web page: https://www.math.ntnu.no/emner/ST2304/2022v/
...
If we go back to being on campus, do you want be on campus or live, or bits of both?

<!---
![https://www.menti.com/kemafew5ei](mentimeter_qr_code.png){height=50%}
--->
(this is to give me some idea of what you want: I plan to ask again if we are told we can be on campus)
...
- Discussion board (under "learning materials")
- announcements
...
- Add the topics to padlet: https://padlet.com/bobohara/34qn1yw4ww0ggr3s

(remind me to give the padlet link in the chat)
